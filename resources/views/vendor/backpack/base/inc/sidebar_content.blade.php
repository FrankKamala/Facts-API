...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('transaction') }}'><i class='nav-icon fa fa-question'></i>Transactions</a></li>
...
<li class="nav-item nav-dropdown">
  ...
  <ul class="nav-dropdown-items">
    ...
    <li class="nav-item"><a class="nav-link" href='{{ backpack_url('role') }}''><i class="nav-icon fa fa-group"></i> <span>User Roles</span></a></li>
  </ul>
</li>
