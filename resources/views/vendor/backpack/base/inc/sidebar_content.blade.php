...
<li class="nav-title">Invoices & Transactions</li>
...
<li class="nav-title">Users & Bank Accounts</li>
<li class="nav-item"><a class="nav-link" href='{{ backpack_url('user') }}'><i class="nav-icon fa fa-user"></i> Users</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('account') }}'><i class='nav-icon fa fa-bank'></i> Accounts</a></li>


<li class="nav-title">Admin Settings</li>
